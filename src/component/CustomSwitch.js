    ...
    return (
        <View style={styles.container}>
            <TouchableOpacity style={{
                ...
                <LinearGradient colors={['#4c669f', '#3b5998', '#192f6a']} style={styles.mainStyes}>
                    <Animated.View style={[{
                        flex:1,
                        ...
                        <Animated.View style={[{
                            ...
                            <LinearGradient colors={['#4c669f', '#3b5998', '#192f6a']} style={styles.basicStyle}>
                                <Icon style={{ transform: [{ rotate: '270deg' }] }} name="poweroff" size={40} color={isOn ? '#fb7185' : '#34d399'} />
                            </LinearGradient>
                        </Animated.View>
